---
name: octokit-sdk
description: everything you need to know about octokit.js, form github's official SDK for REST and GraphQL API requests, GitHub App authentication, and webhooks
---
